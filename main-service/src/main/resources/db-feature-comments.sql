...
ALTER TABLE COMMENTS
    ADD CONSTRAINT COMMENTS FOREIGN KEY (EVENT_ID) REFERENCES EVENTS (ID) ON DELETE CASCADE;

ALTER TABLE COMMENTS
    ADD CONSTRAINT COMMENTS FOREIGN KEY (AUTHOR_ID) REFERENCES USERS (ID) ON DELETE CASCADE;